...
object EncodingProtocol {
    ...
    fun encryptAES(rawEncryptionKey: ByteArray, rawData: ByteArray, associatedData: ByteArray?): ByteArray {
    ...
    @Suppress("MagicNumber")
    fun decryptAES(rawEncryptionKey: ByteArray, encryptedData: ByteArray, associatedData: ByteArray?): ByteArray? {
        val initialOffset = 1
